...
export default function Sidebar({ isOpen, onClose, currentScreen, navigate, onLogout }) {
  ...
  const menuItems = [
    ...
    { id: 'pedidos', label: 'Lista de Pedidos' },
      ...
      <Animated.View style={[styles.drawer, { transform: [{ translateX: slideAnim }] }]}>
        <SafeAreaView style={styles.safeArea}>
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Modulo de Cocina</Text>
          </View>
              ...
              return (
                ...
                >
                  <View style={styles.menuRow}>
                    <Icon name={MENU_ICONS[item.id]} size={18} color={isActive ? '#ffffff' : 'rgba(255,255,255,0.7)'} />
          ...
          <View style={styles.footer}>
            <TouchableOpacity style={styles.logoutButton} onPress={() => { onClose(); onLogout(); }}>
              <View style={styles.menuRow}>
...
const styles = StyleSheet.create({
  ...
  menuItem: { paddingVertical: 14, paddingHorizontal: 12, borderRadius: 12, marginBottom: 8 },
  activeItem: { backgroundColor: 'rgba(255, 255, 255, 0.15)' },
  menuRow: { flexDirection: 'row', alignItems: 'center' },
  menuLabel: { fontSize: 16, color: 'rgba(255, 255, 255, 0.8)', fontWeight: '500' },
  activeLabel: { color: '#ffffff', fontWeight: '700' },
  footer: { paddingVertical: 20, borderTopWidth: 1, borderTopColor: 'rgba(255, 255, 255, 0.1)' },
  logoutButton: { paddingVertical: 12, alignItems: 'center', backgroundColor: 'rgba(255, 118, 117, 0.15)', borderRadius: 12 },
