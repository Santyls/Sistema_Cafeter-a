...
export default function Login({ cambiarPantalla, onBack }) {
...
const styles = StyleSheet.create({
  ...
  appTitleText: { fontSize: 28, fontWeight: "bold", letterSpacing: -0.5, color: "#2D1E16" },
  ...
  linksText: { fontSize: 14, fontWeight: "500", color: "#8D6E63" },
